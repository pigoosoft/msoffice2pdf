...
// Run executes convert-worker argv (without the convert-worker command name).
func Run(args []string) error {
	...
	if err := conv.Convert(context.Background(), src, dst, converter.PasswordFromEnv()); err != nil {
