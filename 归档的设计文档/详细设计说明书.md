...
| 最后更新 | 2026-08-07 |
| 维护人 | Admin |
| 配套文档 | 《架构设计说明书》《使用文档》；配置键说明见 `config/config.template_zh.yaml` / `config/config.template_en.yaml` |

本文描述模块职责、数据结构设计、接口设计、转换与清理算法级约定。总体分层与部署见《架构设计说明书》。操作步骤与 curl 示例见《使用文档》。
...
| 转换算法/业务逻辑变更 | 2.4/2.5 转换细则 | PR 合入后 3 个工作日内 |
